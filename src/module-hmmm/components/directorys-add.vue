<template>
  <div class="container">
    <el-dialog title="新增目录" :visible.sync="dialogVisible" width="30%" :before-close="cancel">
      <el-form ref="form" :model="form" label-width="100px" class="demo-ruleForm">
        <el-form-item label="所属学科" >
            <el-select placeholder="请选择" v-model="condition" style="width:100%" @change="selecChange">
